...
if ( TRACE ) { TRACE( "FinishLineColider#OnTriggerEnter", this ); }
                ...
                if (other.gameObject.CompareTag("Car") && other.gameObject.transform.parent.Find("Car").TryGetComponent$1(PlayerController, _discard1)) {
            ...
            /*FinishLineColider.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "FinishLineColider#Update", this ); }

                if (UnityEngine.Input.GetKeyUp(UnityEngine.KeyCode.Space)) {
                    GameManager.OnGameOver.Invoke(true);
                }
            },
            /*FinishLineColider.Update end.*/
...
if ( TRACE ) { TRACE( "GameManager#init", this ); }
                    ...
                    this.OnGameOver = new (UnityEngine.Events.UnityEvent$1(System.Boolean))();
                }
            }
        },
        fields: {
...
if ( TRACE ) { TRACE( "GameManager#OnDisable", this ); }
            ...
            HandleOnGameOver: function (isPlayerWin) {
...
if ( TRACE ) { TRACE( "GameOverPanel#OnDisable", this ); }
            ...
            /*GameOverPanel.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "GameOverPanel#Start", this ); }

                this.gameOverPanel.GetComponent(UnityEngine.CanvasGroup).alpha = 0; // Start hidden
            },
            /*GameOverPanel.Start end.*/

            /*GameOverPanel.HandleGameOver start.*/
            HandleGameOver: function (isPlayerWin) {
if ( TRACE ) { TRACE( "GameOverPanel#HandleGameOver", this ); }

                DG.Tweening.DOTweenModuleUI.DOFade(this.gameOverPanel.GetComponent(UnityEngine.CanvasGroup), 1, 0.5);
                this.gameOverPanel.gameObject.SetActive(true);
                this.retryButton.anchoredPosition = new pc.Vec2( 0, -1000 );
                DG.Tweening.TweenSettingsExtensions.SetDelay(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.DOTweenModuleUI.DOAnchorPosY(this.retryButton, -100, 1.0), DG.Tweening.Ease.OutBack), 0.4);
                this.finishTxt.text = isPlayerWin ? "You Win" : "You Lose";
            },
...
if ( TRACE ) { TRACE( "BtnReset#OnClick", this ); }
                ...
                DG.Tweening.DOTweenModuleUI.DOAnchorPosY(this.transform.GetComponent(UnityEngine.RectTransform), 200, 1.0);
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","UnityEngine.EventSystems","System.Collections.Generic","UnityEngine.UI","UnityEngine.Events","Cinemachine","TMPro","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*FinishLineColider start.*/
    $m("FinishLineColider", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void}]}; }, $n);
    /*FinishLineColider end.*/
